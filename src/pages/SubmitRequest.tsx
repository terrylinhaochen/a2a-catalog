...
const SubmitRequest = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Save work request to database with service source
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <SEO 
        title="Submit Work Request | A2A Catalog"
        description="Submit your work request and get connected with expert agents"
        keywords="work request, AI agents, professional services"
        url="https://a2acatalog.com/submit-request"
      />
