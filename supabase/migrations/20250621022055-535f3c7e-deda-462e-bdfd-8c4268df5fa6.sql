...
('GTasks MCP', 'MCP server to manage Google Tasks with comprehensive task management features', 'zcaceres', 'https://github.com/zcacares/gtasks-mcp', ARRAY['Communication', 'Productivity'], ARRAY['google_tasks', 'task_management', 'productivity'], 0, NOW(), NOW()),
